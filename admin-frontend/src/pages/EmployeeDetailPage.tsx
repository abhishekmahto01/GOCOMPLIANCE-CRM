  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            to={`/permissions?userId=${employee.user_id}`}
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg border border-slate-300 hover:bg-slate-100 text-slate-700 font-semibold text-xs transition-all"
          >
